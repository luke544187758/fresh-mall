...
func (x *UserFavRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UserFavRequest) GetGoodsId() int64 {
	if x != nil {
		return x.GoodsId
	}
	return 0
...
func (x *UserFavResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UserFavResponse) GetGoodsId() int64 {
	if x != nil {
		return x.GoodsId
	}
	return 0
...
var file_userfav_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xaf, 0x01, 0x0a, 0x07, 0x55, 0x73, 0x65,
...
var file_userfav_proto_depIdxs = []int32{
	...
	2, // 4: UserFav.GetFavList:output_type -> UserFavListResponse
	3, // 5: UserFav.AddUserFav:output_type -> google.protobuf.Empty
	3, // 6: UserFav.DeleteUserFav:output_type -> google.protobuf.Empty
